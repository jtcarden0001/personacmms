...
type Store interface {
	...
	// consumable
	AssociateConsumableWithTask(uuid.UUID, uuid.UUID, string) (tp.ConsumableQuantity, error)
	AssociateConsumableWithWorkOrder(uuid.UUID, uuid.UUID, string) (tp.ConsumableQuantity, error)
	...
	ListConsumablesByTask(uuid.UUID) ([]tp.ConsumableQuantity, error)
	ListConsumablesByWorkOrder(uuid.UUID) ([]tp.ConsumableQuantity, error)
