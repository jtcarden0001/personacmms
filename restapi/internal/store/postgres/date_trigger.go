...
func (pg *PostgresStore) DeleteDateTrigger(dtId uuid.UUID) error {
...
func (pg *PostgresStore) ListDateTriggersByTaskId(taskId uuid.UUID) ([]tp.DateTrigger, error) {
...
func (pg *PostgresStore) GetDateTrigger(dtId uuid.UUID) (tp.DateTrigger, error) {
...
func (pg *PostgresStore) UpdateDateTrigger(dtId uuid.UUID, dt tp.DateTrigger) (tp.DateTrigger, error) {
