...
func (pg *PostgresStore) DeleteUsageTrigger(utId uuid.UUID) error {
...
func (pg *PostgresStore) GetUsageTrigger(utId uuid.UUID) (tp.UsageTrigger, error) {
...
func (pg *PostgresStore) ListUsageTriggersByTaskId(taskId uuid.UUID) ([]tp.UsageTrigger, error) {
	var uts []tp.UsageTrigger
...
func (pg *PostgresStore) UpdateUsageTrigger(utId uuid.UUID, ut tp.UsageTrigger) (tp.UsageTrigger, error) {
